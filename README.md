...
Cette chaîne est nouvelle : tant que STATUS.md ne consigne pas un run vert et un essai
sur une machine vierge, l'installateur n'est pas annoncé comme éprouvé.
